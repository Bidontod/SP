...
#define KEYWORDS_RE       ";|->|\\+\\+|--|\\*\\*|,|Eg|Ne|:|\\[|\\]|\\(|\\)|\\{|\\}|Program|Var|Start|Finish|Scan|Print|If|Else|Goto|Div|Mod|Le|Ge|Not|And|Or|Int_4"
#define IDENTIFIERS_RE    "_[a-z][a-z][a-z]"
